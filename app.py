...
with tab3:
    ...
    fig=px.scatter(analysis_df, x='popularity_trend', y='average_rank', title='Popularity vs Rank Analysis',color='popularity_trend',size='popularity_trend', hover_data=['song_id','popularity_trend'])
    fig.update_yaxes(autorange='reversed')
